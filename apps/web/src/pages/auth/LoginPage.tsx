...
export function LoginPage() {
  ...
  useEffect(() => {
    // If no users exist in the database, automatically route to register.
    // We check this by seeing if the admin-id endpoint returns null.
    fetch("/api/auth/admin-id")
      ...
      .catch((_) => {}); // ignore errors, just stay on login
  }, [navigate]);
  return (
